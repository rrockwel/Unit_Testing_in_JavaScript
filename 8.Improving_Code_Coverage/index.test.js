...
describe('#Person', ()=>{
	...
	describe('#attack', ()=>{
		...
		// Verify that if an item is added to equipment it shows up in array
		it("If I add a chainsaw to my equipment, it's in the array", ()=>{
			const chainsaw = new Weapon('Chainsaw', 
		});
	})
})
